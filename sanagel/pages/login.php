    ...
    <div class="form">
        <div class="formom">
            <form class="signup-form" action="../index.php" method="post">
                <input type="hidden" name="signed" value="up">
                ...
                <div class="input">
                    <input type="password" minlength="1" required name="password" autocomplete="off">
                    <label for="password">Password: </label>
                    <span></span>
                </div>
                <div class="input">
                    <input type="password" min="1" required name="confirm-password" autocomplete="off">
                ...
                <div class="birthday">
                    ...
                    <label class="label" for="day">Month: </label>
                    ...
                    <label class="label" for="day">Year: </label>
                    <select name="year" id="">
            ...
            <form class="login-form" action="../index.php" method="post">
                <input type="hidden" name="signed" value="in">
